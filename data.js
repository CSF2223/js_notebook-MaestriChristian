...
newEngland.length;            // sets or returns he number of elements in an array 
newEngland.push("New York");    // Adds new elements to the end of an array and returns the new
newEngland.pop();      // removes the last elements of an array and returnes that element
newEngland.indexOf("Rhode Island", 0);       // seach the array for an elemetn and returns its posiiton 
